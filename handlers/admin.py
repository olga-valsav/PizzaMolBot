# будем указывать о том что этот хендлер используется в машиносстоянии
...
# создаем классы состояний и унаследуемся от базового класса
...
# Ловим первый ответ и пишем в словаь
# @dp.message_handler(content_types=['photo'], state=FSMAdmin.photo)
async def load_photo(message: types.Message, state: FSMContext):
    if message.from_user.id == ID:
        # кажому отправленому файлу присваеивается уникальный ид номер
